...
ssh -i ./secrets/id_rsa root@$SSH_ADDRESS '
  cd /stream-site/ && docker compose pull && docker compose -p stream-site up -f docker-compose.yml -f docker-compose-prod.yml --build --force-recreate --renew-anon-volumes --detach
'
