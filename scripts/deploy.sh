...
ssh -i ./secrets/id_rsa root@$SSH_ADDRESS '
  cd /stream-site/ && docker compose pull && docker compose -p stream-site -f docker-compose.yml -f docker-compose-prod.yml up --build --force-recreate --renew-anon-volumes --detach
'
